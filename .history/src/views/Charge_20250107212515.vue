        ...
        <el-card class="query-card">
          <el-form :model="queryForm" label-width="100px" class="query-form">
            ...
            <el-form-item label="患者姓名" class="large-font">
              ...
              <el-button type="primary" @click="handleSearch" style="margin-left: 10px; margin-top: 10px;">查询</el-button>
    ...
    async handlePatientSelect(patientNumber) {
      ...
      if (selectedPatient) {
        ...
        try {
          ...
          // 更新费用明细和费用总额
          this.form.feeDetails = chargeData.feeDetails || [];
          this.form.totalAmount = chargeData.totalAmount || 0;
          this.form.insuranceAmount = chargeData.insuranceAmount || 0;
          this.form.payAmount = chargeData.payAmount || 0;
        } catch (error) {
