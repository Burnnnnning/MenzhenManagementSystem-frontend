    ...
    setup() {
        ...
        const fetchData = async (area, year) => {
            ...
            try {
                ...
                console.log('data.total_water:', data.total_water);
                console.log('waterResource:', data.total_water);
                console.log('waterResource:', typeof data.total_water)
                console.log('waterResource:', typeof data.total_water)
                console.log('Type:', typeof data.total_water)
