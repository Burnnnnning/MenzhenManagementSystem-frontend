  ...
  methods: {
    ...
    handlePatientSelect(patientId) {
      ...
      if (selectedPatient) {
        ...
        this.form.feeDetails = selectedPatient.feeDetails; // 动态更新费用明细
        this.form.totalAmount = selectedPatient.totalAmount; // 动态更新总费用
        this.form.insuranceAmount = selectedPatient.insuranceAmount; // 动态更新医保报销金额
        this.form.payAmount = selectedPatient.payAmount; // 动态更新自费金额
      }
    },
