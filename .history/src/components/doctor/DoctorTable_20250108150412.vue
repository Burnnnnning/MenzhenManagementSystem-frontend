<template>
  <div class="search-container">
    <el-row justify="space-between" align="middle" style="margin-bottom: 1px">
      <!-- 添加医生信息按钮（左侧） -->
      <el-button type="success" @click="handleAdd" class="custom-button" <!-- 添加类名 -->
        >
        添加医生信息
      </el-button>
      ...
      <el-form :inline="true">
        <el-form-item>
          <el-input v-model="searchForm.name" placeholder="请输入医生姓名" class="custom-input" <!-- 添加类名 -->
            ></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="search" class="custom-button" <!-- 添加类名 -->
            >
            查询
          </el-button>
        </el-form-item>
  ...
  <div class="table-container" v-loading="loading">
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column prop="Doctor_Number" label="医生编号" min-width="80"></el-table-column>
      <el-table-column prop="Name" label="医生姓名" min-width="60"></el-table-column>
      <el-table-column prop="Gender" label="医生性别" min-width="60"></el-table-column>
      <el-table-column prop="Age" label="医生年龄" min-width="60" sortable></el-table-column>
      <el-table-column prop="Department" label="医生科室" min-width="80" sortable></el-table-column>
      <el-table-column prop="Contact_Phone" label="联系电话" min-width="80" sortable></el-table-column>
      <el-table-column prop="Outpatient_Time" label="出诊时间" min-width="100" sortable></el-table-column>
      <el-table-column prop="Registration_Fee" label="挂号费" min-width="60" sortable></el-table-column>
  ...
  <el-dialog v-model="centerDialogVisible" :title="dialogTitle" width="500" center>
    <el-form :model="form" label-width="100px">
      ...
      <el-form-item label="挂号费">
        <el-input v-model="form.Registration_Fee" placeholder="请输入挂号费"></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
      ...
      if (this.dialogTitle === "新增") {
        try {
          ...
          const response = await api_doctor.addDoctor({
            ...
            registration_fee: this.form.Registration_Fee, // 挂号费
          });
          if (response.code === 200) {
        ...
        try {
          ...
          const response = await api_doctor.updateDoctor({
            ...
            new_registration_fee: this.form.Registration_Fee, // 挂号费
          });
          if (response.code === 200) {
    ...
    getTableData() {
      this.tableData = this.structData.map((item) => {
        ...
        return {
          ...
          Registration_Fee: item.Registration_Fee, // 挂号费
        };
      });
    },
  },
