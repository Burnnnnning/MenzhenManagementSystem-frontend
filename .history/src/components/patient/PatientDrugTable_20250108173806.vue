<template>
    <div>
        ...
        <el-row justify="space-between" align="middle">
            <!-- 添加处方信息按钮（左侧） -->
            <el-button type="success" @click="handleAdd" style="margin-top: -15px" class="custom-button">添加处方信息</el-button>
        ...
        <el-dialog v-model="centerDialogVisible" :title="dialogTitle" width="500" center>
            <el-form :model="form" label-width="120px">
                ...
                <el-form-item label="开具日期">
                    <el-input v-model="form.Treatment_Time" type="datetime" placeholder="输入开具时间"></el-input>
                </el-form-item>
            </el-form>
            <template #footer>
