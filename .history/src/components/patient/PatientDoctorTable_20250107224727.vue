<template>
    <div>
        ...
        <el-row justify="space-between" align="middle">
            <!-- 添加患者与医生关系按钮（左侧） -->
            <el-button type="success" @click="handleAdd" style="margin-top: -15px">添加挂号关系</el-button>
        ...
        <el-dialog v-model="centerDialogVisible" :title="dialogTitle" width="500" center>
            <el-form :model="form" label-width="120px">
                ...
                <el-form-item label="就诊时间">
                    <el-date-picker v-model="form.Medical_Time" type="datetime" placeholder="选择就诊时间"
