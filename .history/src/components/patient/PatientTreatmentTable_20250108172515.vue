<template>
    <div>
        ...
        <el-row justify="space-between" align="middle">
            <!-- 添加治疗项目按钮（左侧） -->
            <el-button type="success" @click="handleAdd" style="margin-top: -15px" class="custom-button">添加诊疗项目</el-button>

            <!-- 搜索框和查询按钮（右侧） -->
            <el-form :inline="true">
                <el-form-item>
                    <el-input v-model="searchForm.name" placeholder="请输入患者编号" class="custom-input"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <el-dialog v-model="centerDialogVisible" :title="dialogTitle" width="500" center>
            <el-form :model="form" label-width="150px">
                <el-form-item label="治疗项目编号" v-if="dialogTitle === '编辑'">
                ...
                <el-form-item label="治疗时间">
                    <el-input v-model="form.Treatment_Time" type="datetime" placeholder="输入治疗时间"></el-input>
                </el-form-item>
            </el-form>
            <template #footer>
