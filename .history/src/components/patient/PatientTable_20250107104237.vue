  ...
  <div>
    ...
    <div class="table-container" v-loading="loading">
      <el-table :data="tableData" border stripe style="width: 100%">
        ...
        <el-table-column prop="Name" label="患者姓名" min-width="70"></el-table-column>
        ...
        <el-table-column prop="ID_Card_Number" label="身份证号" min-width="150"></el-table-column>
        ...
        <el-table-column prop="Medical_Insurance" label="医保信息" min-width="120"></el-table-column>
